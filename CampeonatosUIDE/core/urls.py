...
from .views import (
    # Rutas existentes
    vista_inicio, vista_login, vista_logout, vista_registro,
    vista_inicio_publico, detalle_equipo,
    # Panel de administración
    vista_dashboard,
    # Árbitros
    listar_arbitros, registrar_arbitro, editar_arbitro, detalle_arbitro,
    # Campeonatos
    listar_campeonatos, crear_campeonato, editar_campeonato, detalle_campeonato, fixture_campeonato,
    # Equipos (nuevas vistas que puedes tener en equipo_views.py si lo separas)
    listar_equipos, registrar_equipo, editar_equipo, pago_equipo, jugadores_equipo,
    # Estadísticas por deporte (si decides usarlas)
...
urlpatterns = [
    ...
    path('equipos/nuevo/', registrar_equipo, name='registrar_equipo'),
    path('equipos/<int:id>/editar/', editar_equipo, name='editar_equipo'),
    path('equipos/<int:id>/pago/', pago_equipo, name='pago_equipo'),
    path('equipos/<int:id>/jugadores/', jugadores_equipo, name='jugadores_equipo'),
