...
Este módulo contenía su propio contenido repetido dos y tres veces: cada
clase estaba definida hasta tres veces y Python sólo conservaba la última,
de modo que unas 500 de sus 850 líneas nunca se ejecutaban y editar la
primera copia no tenía ningún efecto.

Se conservó exclusivamente la última definición de cada clase -- la que ya
estaba en uso -- por lo que el comportamiento es idéntico.
"""
